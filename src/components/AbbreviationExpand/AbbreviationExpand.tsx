...
function Word(props: WordProps ) {
    ...
    return (
        <Box display={"flex"} flexDirection={"row"} alignItems={"center"}>
            ...
            {!collapses && <span style={{transition: ".5s", opacity: props.expanded ? "0%" : "100%"}}>.</span>}
            <div style={{maxWidth: props.expanded ? "100px" : "0px", transition: ".5s ease", marginRight: (collapses && !props.expanded) ? "0px" : "1rem"}}>
