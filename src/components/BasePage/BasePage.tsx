import { Alert, Box, Button, Card, CardActions, CardContent, CardHeader, Container, Divider, Snackbar, Typography } from "@mui/material";
...
function MyFallbackComponent({ error, resetErrorBoundary }) {
    return (
      <Container>
        <Card sx={{width: "100%", marginTop:4, display: "flex", flexDirection:"column"}}>
            <CardHeader title={"Ooops, something went wrong! 🦧"}></CardHeader>
            <CardContent>
                <Divider />
                <Typography mt={2} variant="body1" color={"error"}>{error.message}</Typography>
            </CardContent>
...
export function BasePage(props: BasePageProps) {
    ...
    return (<>
        ...
        <Snackbar open={props.alert.isOpen} anchorOrigin={{horizontal:"right", vertical: "bottom"}} autoHideDuration={10000} onClose={handleClose}>
